...
export default function AdminProductAdd(props) {
  ...
  const submit = () => {
    Axios.post(apis.base + apis.addproduct, data).then((response) => {
        ...
        <div className="row form-group">
          <div className="col-md-6">
            ...
            <input
              ...
              onChange={(event) =>
                setData({ ...data, costPrice: event.target.value })
              }
              className="form-control"
            />
          </div>
          <div className="col-md-6">
            ...
            <input
              type="number"
              value={data.adminShare}
              onChange={(event) =>
                setData({ ...data, adminShare: event.target.value })
              }
              className="form-control"
            />
          </div>
          ...
          <div className="custom-file">
            <div className="custom-file">
              <input
                ...
                accept="image/*"
                onChange={(event) =>
                  setData({ ...data, imageSub: event.target.files[0] })
                }
              />
              <label className="custom-file-label" htmlFor="customFile">
                Choose file
